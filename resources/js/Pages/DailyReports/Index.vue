    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <Link :href="route('daily-reports.create', { placement_id: placementId || undefined })" class="inline-flex items-center gap-2 rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-500">
                ...
                <template #table>
                    ...
                    <tbody>
                        ...
                        <tr v-if="!props.dailyReports.data || props.dailyReports.data.length === 0">
                            <td :colspan="canReview ? 7 : 6" class="px-2 py-4 text-center text-slate-500">No daily reports found.</td>
                        </tr>
                    </tbody>
                </template>
            </DataTable>
